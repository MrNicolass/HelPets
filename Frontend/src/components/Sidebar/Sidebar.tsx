...
import { FaChartBar, FaUserFriends, FaBell, FaCog, FaSignOutAlt, FaPaw, FaExclamationTriangle } from "react-icons/fa";
    ...
    <aside className="bg-[#F5F7FA] w-64 min-h-screen flex flex-col justify-between border-r border-gray-600 dark:bg-gray-500">
      <div>
        <div className="flex flex-col items-center py-8">
          ...
          <span className="font-bold text-lg text-gray-700 mb-6 dark:text-gray-100">Logo</span>
        </div>
        {/* Navigation Menu */}
      ...
      <div className="flex flex-row items-center justify-between py-8 border-t border-gray-600 px-6 gap-3">
        ...
        <div className="flex flex-col flex-1 items-start ml-3">
          <span className="font-semibold text-gray-200 leading-tight">Lorem</span>
          <span className="text-xs text-gray-400 leading-tight">Ipsum</span>
        </div>
        <button className="text-gray-400 dark:text-gray-300 hover:text-red-500 cursor-pointer transition-colors text-xl ml-2">
          <FaSignOutAlt />
        </button>
      </div>
    </aside>
